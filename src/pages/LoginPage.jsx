      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-xl border border-teal-100 overflow-hidden">
          <div className="bg-teal-600 px-8 py-6 text-center">
            <div className="mx-auto mb-3 w-28 h-28 rounded-3xl bg-white p-2 shadow-lg overflow-hidden">
              <img src="/dawaa-logo.jpg" alt="شعار صيدليات دواء" className="w-full h-full object-cover rounded-2xl" />
            </div>
            <h1 className="text-2xl font-extrabold text-white">صيدليات دواء</h1>
            <p className="text-teal-50 mt-1 font-medium">نظام المشتريات والحسابات</p>
          </div>
          ...
          <form onSubmit={submit} className="p-7 space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input value={username} onChange={(e) => setUsername(e.target.value.toLowerCase())} autoComplete="username" placeholder="مثال: dr.moaz" className="w-full h-12 pr-11 pl-4 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent text-left" dir="ltr" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input value={pin} onChange={(e) => setPin(e.target.value.replace(/\D/g, '').slice(0, 12))} type={showPin ? 'text' : 'password'} inputMode="numeric" autoComplete="current-password" placeholder="••••" className="w-full h-12 pr-11 pl-12 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent text-center tracking-[0.35em] text-lg" dir="ltr" />
